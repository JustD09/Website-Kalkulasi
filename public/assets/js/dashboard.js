    ...
    $(function () {
                    ...
                    datasets: [
                        {
                            label: "This week",
                            data: [
                                46, 49, 51, 58, 63.61, 65, 64, 69, 70, 78, 80,
                                80, 90, 85, 87, 92, 97, 102, 107, 109, 111, 111,
                                120, 130, 132, 136, 140, 145,
                            ],
                        ...
                        },
                        {
                            label: "Current week",
                            data: [
                                16, 19, 21, 28, 33.31, 35, 34, 39, 40, 48, 50,
                                50, 51, 55, 57, 62, 67, 69, 68, 70, 72, 75, 74,
                                80, 79, 80, 84, 90,
                            ],
                            backgroundColor: ["rgba(216,247,234, 0.19)"],
                            borderColor: ["#3dd597"],
        ...
        if ($("#prediction-1").length) {
            ...
            var graphGradient1 = document
                .getElementById("prediction-1")
                .getContext("2d");

            var gradientColor = graphGradient1.createLinearGradient(
                25,
                0,
                25,
                80
        ...
        if ($(".navbar").hasClass("fixed-top")) {
            ...
            document
                ...
                .classList.remove("proBanner-padding-top");
        } else {
