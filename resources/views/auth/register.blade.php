...
<html lang="en">
  <head>
    ...
    <title>Register | WEB Merchant Gojek</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form action="{{ route('register.save') }}" method="POST" class="user" class="pt-3">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input name="password" type="password" class="form-control form-control-lg border-left-0 @error('password')is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input name="password_confirmation" type="password" class="form-control form-control-lg border-left-0 @error('password_confirmation')is-invalid @enderror"
